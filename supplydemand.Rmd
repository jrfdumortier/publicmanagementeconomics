...
In 2012, a severe drought hit farmers and cropland in the United States.\footnote{\emph{The Economist} has at least two articles on this subject titled ``The 2012 drought will dent farm profits and push up food prices'' (July 21st, 2012) and ``Supply shocks: Feeling a drought'' (August 14th, 2012) which summarizes the effects on agricultural markets.} Figure \ref{fig:SND_drought} illustrates the areas affected by the drought and the intensity. As mentioned in the article, the world price of corn increases by 30\% because the U.S. is responsible for 52.5\% of world corn exports.

### Examples
\noindent \emph{Numerical Example}\\
Demand as a function of income, i.e., $q^d = f(p,I)$:
    \begin{equation*}
        q^d = 300-2p+4I
    \end{equation*}
Supply as a function of the price
    \begin{equation*}
        q^s = 3 p - 50
    \end{equation*}
...
\noindent \emph{Demand for U.S. Wheat}\\
Initial situation in 1998:
    \begin{gather*}
        q^d = 3244-283 \cdot p\\
        q^s = 1944 + 207 \cdot p\\
        p = 2.65
    \end{gather*}
At the end of 1998, Indonesia and Brazil open their market for U.S. wheat, i.e., 200 million bushels of additional demand
    \begin{gather*}
        q^d = 3444-283 \cdot p\\
        p =3.06
    \end{gather*}
...
% Explain the relationship between elasticity and revenue using a graph with the demand function and the area in terms of revenue change.
...
In a 2005 article,\footnote{``To Reduce the Cost of Teenage Temptation, Why Not Just Raise the Price of Sin?'' by David Leonhardt in the New York Times, 25 July 2005} the New York Times lists examples how an increase in the price of cigarette and alcohol taxes reduces the consumption of those goods by teenagers. Those consumers have a much higher elasticity with respet to consumption than adults. The article states that
...
1. The demand for books is $Q^D = 81-P$ and the supply of books is $Q^S = 8 \cdot P$. What is the equilibrium quantity and price?

2. The demand for gasoline in the U.S. is very inelastic. Why do you think that is the case? Assume that it is -0.2. If gasoline prices decrease by 3\%, by how many percent does the quantity demanded change?

3. The demand function for ice cream is $Q=T-5 \cdot P-40$ where $Q$, $P$, and $T$ represent the quantity, price, and temperature, respectively.
