# Producer Theory
The goal of producer theory is to derive the supply curve. We will first look at production functions and profit maximization. In the subsequent section, we will talk about cost minimization which ultimately leads to the supply function.
...
isocostfun              = function(C,L){(C-pL*L)/pK}
     Q        = 0.5
     curve(isoquantfun,from=0,to=2,yaxs="i",xaxs="i",ylim=c(0,2),ylab="Machinery",xlab="Workers")
