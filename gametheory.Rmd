...
In the prisoner's dilemma game, there is one Nash Equilibrium. Note that it is not the optimal outcome. Every Nash Equilibrium is characterized as a state where no player has the incentive to deviate. There is also a [Dilbert cartoon](https://www.youtube.com/watch?v=ED9gaAb2BEw) associated with the prisoner's dilemma. A more thorough video explaining the prisoner's dilemma can be found [here](https://www.youtube.com/watch?v=t9Lo2fgxWHw). 
